...
def record_greeting(speech_config):
    ...
    output_file = os.path.join(script_dir, "greeting.wav")
...
def transcribe_messages(speech_config):
    ...
    messages_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), "messages")
